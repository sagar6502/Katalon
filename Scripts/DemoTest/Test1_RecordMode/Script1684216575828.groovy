...
//import com.kms.katalon.core.webui.chrome(headless)
...
WebUI.setText(findTestObject('Object Repository/Page_CURA Healthcare Service/textarea_Comment_comment'), 'Appointment is done')
