...
WebUI.click(findTestObject('Object Repository/Page_Capabilities/a_org.openqa.selenium.concurrent'))

WebUI.click(findTestObject('Object Repository/Page_Capabilities/a_GuardedRunnable'))
